...
Evaluates an expression and produces a reference to its result, preserving the identity of the referenced anchor or property rather than embedding its value or converting it to a string.
