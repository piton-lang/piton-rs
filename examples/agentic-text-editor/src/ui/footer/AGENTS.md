...
- The line ending, from [Encoding](../../../.claude/reference/shape/files/Encoding.md), reading CRLF or LF, and clicking it offers the other
...
- The readouts update every frame from [Document](../../../.claude/reference/shape/document/Document.md); nothing here is cached
