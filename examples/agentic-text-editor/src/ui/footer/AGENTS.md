...
- The line ending, from @../../../.claude/reference/shape/files/Encoding.md, reading CRLF or LF, and clicking it offers the other
...
- The readouts update every frame from @../../../.claude/reference/shape/document/Document.md; nothing here is cached
