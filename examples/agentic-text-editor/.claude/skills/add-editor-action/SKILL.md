...
Read @../../reference/concept/ActionSystem.md first. An action is one row in one table, and the menus, the buttons and the shortcuts are renderings of that table. If you find yourself editing @../../reference/shape/ui/header/MenuBar.md to add a menu item, you are doing it the wrong way round.

# Order

- Add the row to @../../reference/shape/app/ActionCatalogue.md, editing the Piton source under `spec/shape/app` rather than the generated Markdown
...
- The action belongs on @../../reference/shape/ui/header/Toolbar.md only if it is one of the few someone reaches for constantly
