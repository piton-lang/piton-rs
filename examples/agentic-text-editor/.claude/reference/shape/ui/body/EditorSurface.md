...
The surface is a multiline text edit that fills the body, backed by the buffer in @../../document/Document.md. It renders the text and reports edits; it does not own the text and it does not decide what an edit means.
...
- The caret and the selection use the accent colour from @../../theme/Tokens.md, and the selection stays visible when focus is elsewhere
