...
- The line ending, from [Encoding](../../files/Encoding.md), reading CRLF or LF, and clicking it offers the other
...
- The readouts update every frame from [Document](../../document/Document.md); nothing here is cached
