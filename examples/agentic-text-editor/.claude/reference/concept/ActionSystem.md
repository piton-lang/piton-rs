...
- [ActionCatalogue](../shape/app/ActionCatalogue.md) - the table itself, grouped the way the menus are
- [MenuBar](../shape/ui/header/MenuBar.md) - renders the groups as menus
- [Toolbar](../shape/ui/header/Toolbar.md) - renders the handful marked as common
- [StatusBar](../shape/ui/footer/StatusBar.md) - reports what the last action did, when it has something to say
