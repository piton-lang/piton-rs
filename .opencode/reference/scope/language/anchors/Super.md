...
```
As with the previous example of multiple inheritance, the anchor could be inheriting from multiple bases, in which case what does super point to? It follows the same authority as property inheritance in that left to right, last in line wins.
